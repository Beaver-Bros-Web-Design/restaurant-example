  ...
  return (
          ...
          <div style={{ position: 'relative', height: 'auto' }}>
            ...
            <div style={{ position: 'relative', zIndex: 2 }}>
              <Stack sx={{ justifyContent: "center", alignItems: "center", paddingTop: "50px" }}>
                <Typography sx={{ fontWeight: "bold", fontSize: "30px" }}>
                  CATERING
                </Typography>

                <Typography sx={{ fontWeight: "bold", fontSize: "20px", textAlign: "center", width: "70%" }}>
                ...
                <Box sx={{backgroundColor:"blue", height:"1000px"}}>
